...
const SignUpForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof SignupValidation>) {
    ...
    if(!newUser){
      return toast({ title: " Sorry, broski, sign up has failed. Please try again =)" });
    }
    ...
    if (!session) {
      return toast({ title: "Oops, session creating has failed. Please, try again =)" })
    }
  ...
  return (
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <p className="text-light-3 small-medium md:base-regular mt-2">To use LifeLens, please enter your details</p>
